...
class Station
{
  ...
  HashMap<Integer, Route> optimalRoutes = new HashMap<Integer, Route>();
  ...
  void addRouteTo(Station station, Route route)
  {  
    optimalRoutes.put(station.getId(), route);
  }

  Route getRouteTo(Station station)
  {
    return optimalRoutes.get(station.getId());
  }
